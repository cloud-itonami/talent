...
(defn collection
  [name]
  (str "com.etzhayyim.talent." name))

(def cell-specs {
  :listoccupations {:legacy-cell "com-etzhayyim-apps-talent-listOccupations"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "listoccupations")]
     :required-gates common-gates
     :trigger "manifest cell listoccupations"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :getcohortstats {:legacy-cell "com-etzhayyim-apps-talent-getCohortStats"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "getcohortstats")]
     :required-gates common-gates
     :trigger "manifest cell getcohortstats"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :registerself {:legacy-cell "com-etzhayyim-apps-talent-registerSelf"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "registerself")]
     :required-gates common-gates
     :trigger "manifest cell registerself"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :forgetself {:legacy-cell "com-etzhayyim-apps-talent-forgetSelf"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "forgetself")]
     :required-gates common-gates
     :trigger "manifest cell forgetself"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :stats {:legacy-cell "com-etzhayyim-apps-talent-stats"
     :phase :event
     :murakumo-node "reuben"
  ...
  :domain-knowledge {:legacy-cell "domain-knowledge"
     ...
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :talentcohort {:legacy-cell "com-etzhayyim-apps-talent-talentCohort"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "talentcohort")]
     :required-gates common-gates
     :trigger "manifest cell talentcohort"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :talentprofile {:legacy-cell "com-etzhayyim-apps-talent-talentProfile"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "talentprofile")]
     :required-gates common-gates
     :trigger "manifest cell talentprofile"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
})
